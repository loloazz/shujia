package SumScoreCombiner;


import SumScore.SumScoreMR;
 ...
 * @Author: Yaolong
 * @Date: 2021/9/2 9:14
 * @Pagename: SumScoreCombiner
 * @ProjectName: shujia
 * @Describe:
 **/


public class SumScoreCombiner {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        job.setJobName("SumScoreCombineMR");
        job.setJarByClass(SumScoreCombiner.class);
        ...
        job.setCombinerClass(SumScoreReduce.class);
